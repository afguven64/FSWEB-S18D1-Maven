...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    //10A veya 10B sınıfındaki öğrencilerin sınıflarını ve okudukları toplam kitap sayısını getirin.
    ...
    String QUESTION_8 = "SELECT o.sinif, COUNT (o.sinif) FROM ogrenci o\n" +
            "GROUP BY o.sinif";
    @Query(value = QUESTION_8, nativeQuery = true)
    List<StudentClassCount> findStudentClassCount();

    String QUESTION_9 = "SELECT o.ad, o.soyad, COUNT (o.ogrno) FROM ogrenci o\n" +
            "INNER JOIN islem i\n" +
            "ON o.ogrno = i.ogrno\n" +
